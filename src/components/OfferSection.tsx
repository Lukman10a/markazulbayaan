    ...
    <div className="py-16 px-4 md:px-8 lg:px-16 font-serif max-w-7xl mx-auto">
      <div className="flex justify-between sm:flex-col py-6  items-center">
        ...
        <p className="max-w-2xl text-lg sm:text-sm text-left">
          At <span className="text-yellow-500">Markazul-Bayan,</span> we provide
          access to a wealth of resources, including authentic{" "}
          <span className="block sm:inline">
            texts, multimedia materials, and interactive sessions, fostering an
            environment{" "}
          </span>{" "}
