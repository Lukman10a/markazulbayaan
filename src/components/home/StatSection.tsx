...
export default function StatSection() {
  return (
    <section className=" bg-slate-100 py-32 ">
      <div className="w-[90%] max-w-[1200px] mx-auto grid grid-cols-3 gap-6">
        <div className=" h-auto min-h-[130px]">
          <p className="text-5xl font-medium font-serif">
            A Platform to Learn the Quran & Sunnah
          </p>
        </div>

        <div className="col-span-2 ">
          <p className="text-sm w-[70%] ml-auto font-inter text-[#556a76]">
        ...
        <div className="row-span-2 col-span-1 relative rounded-lg overflow-hidden">
          ...
          <div className="absolute font-serif bottom-4 text-right w-full flex flex-col items-center justify-center rounded-lg overflow-hidden">
            <div className="text-[#DFB203] text-7xl w-[90%] border-b border-[#DFB203] pb-4">
              100+
            </div>

            <div className="text-[#DFB203] my-2 w-[90%] text-right text-3xl">
              Quranic Lessons Delivered
            </div>
          </div>
        </div>

        <div className="row-span-1 col-span-1 relative font-serif bg-[#B1BAC0] rounded-lg overflow-hidden">
          <div className="absolute bottom-4 text-right w-full flex flex-col items-center justify-center">
            <div className="text-black text-7xl w-[90%] border-b border-black pb-4">
              500+
            </div>

            <div className="text-black my-2 w-[90%] text-right text-3xl">
        ...
        <div className="row-span-1 col-span-1 relative font-serif bg-[#f5e7b1] rounded-lg overflow-hidden">
          <div className="absolute bottom-4 text-right w-full flex flex-col items-center justify-center">
            <div className="text-black text-7xl w-[90%] border-b border-black pb-4">
              100+
            </div>
